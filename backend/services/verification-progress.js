// VerificationStep = { label: string, done: boolean }
// VerificationProgress = { percent: number, steps: VerificationStep[], status: "not_started" | "pending" | "verified" | "rejected" }
...
export function tenantVerificationProgress(v) {
  if (!v) {
    return {
      percent: 0,
      status: "not_started",
