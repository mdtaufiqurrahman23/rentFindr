...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width between 50 to 90%. useState's lazy initializer (not useMemo) is the
  // React-sanctioned place for a one-time non-deterministic value computed during render.
